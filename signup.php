...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($num == 0) {
        if (($password == $cpassword) && $exists == false) {
            ...
            $sql = "INSERT INTO `userinformation` ( `Email`, `Password`) VALUES ('$email', '".md5($password)."')";
    ...
    <div class="container my-4 ">
        ...
        <form action="signup.php" method="post">
            ...
            <div class="form-group">
                ...
                <input required type="text" class="form-control" id="username" name="email" aria-describedby="emailHelp">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" required id="password" name="firstName">
            </div>
            <div class="form-group">
